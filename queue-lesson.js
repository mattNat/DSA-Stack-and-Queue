...
/*
  double linked list - item can only be inserted at the 
  end of the list and items deleted at beginning
*/
class Queue {
  constructor() {
    this.first = null;
  ...
  // enqueue: insertion at end of queue
  enqueue(data) {
  ...
  // dequeue: removal limited to beginning of the queue
  dequeue() {
